package com.qs.courses_alpha.config;
...
public class JHipsterProperties {
    ...
    public static class Swagger {
        ...
        private String title = "Courses_Alpha_QS API";

        private String description = "Courses_Alpha_QS API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "Courses_Alpha_QS";
